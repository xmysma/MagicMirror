...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Ha en bra dag!"],
			morning: ["God morgon!", "Njut av dagen!", "Sovit gott?"],
			afternoon: ["God eftermiddag!", "Ser bra ut idag!", "Njut av eftermiddagen!"],
			evening: ["Ser bra ut ikväll!", "Hej hej!"],
			"....-01-01": ["Gott Nytt År!"]
		},
